      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <p>
              웹 개발에 대한 열정을 가진 풀스택 개발자로, 사용자 중심의 웹 애플리케이션을 만드는 것을 좋아합니다.
              Next.js, React, TypeScript를 주로 사용하며, 최신 웹 기술 트렌드를 항상 탐구하고 있습니다.
            </p>

            <p>
              저는 복잡한 문제를 해결하고 사용자 경험을 개선하는 데 중점을 두고 있습니다. 클린 코드와 최신 웹 표준을
              준수하는 것을 중요하게 생각하며, 지속적인 학습과 성장을 통해 더 나은 개발자가 되기 위해 노력하고 있습니다.
            </p>
              ...
              <CardContent className="flex flex-col items-center">
                ...
                <div className="w-full space-y-2">
                  <div className="flex justify-between text-sm">
                    <span>위치:</span>
                    <span className="text-muted-foreground">서울, 대한민국</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span>경력:</span>
                  ...
                  <div className="flex justify-between text-sm">
                    <span>이메일:</span>
                    <span className="text-muted-foreground">zzangzzong92@gmail.com</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span>언어:</span>
                    <span className="text-muted-foreground">한국어, 중국어</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  {Array.from(new Set(techStack.map((tech) => tech.category))).map((category) => (
                    <div key={category}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {techStack
                          ...
                          .map((tech) => {
                            ...
                            else if (tech.level === "Advanced") variant = "secondary"
                            else if (tech.level === "Intermediate") variant = "outline"
                            else variant = "ghost"

                            return (
                              <Badge key={tech.name} variant={variant as any} className="text-xs">
                                {tech.name}
                              </Badge>
                            )
                          })}
