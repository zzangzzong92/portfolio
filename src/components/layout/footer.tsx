      ...
      <div className="container grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Next.js 15, TypeScript, shadcn/ui로 구축된 개발자 포트폴리오 웹사이트입니다. 최신 웹 기술을 활용한
            프로젝트와 블로그 포스트를 공유합니다.
          </p>
        ...
        <div className="space-y-4">
          ...
          ></div>
          <p className="text-xs text-muted-foreground">* 지도를 보려면 Google Maps API 키가 필요합니다.</p>
        </div>
      </div>
